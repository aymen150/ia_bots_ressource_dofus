...
def my_map() :
    resize_definition = [(300,80),(300,60),(100,25),(300,100),(400,80)]
    option = [False, True]
...
def my_map_dofus(resize, config : bool )  :
    """
    ...
    if config :
        map = pytesseract.image_to_string(image, lang="eng", config='--psm 10 --oem 3 ')
    else :
        map =  pytesseract.image_to_string(image, lang="eng")
